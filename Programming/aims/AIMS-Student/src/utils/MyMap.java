...
/**
 * The {@link utils.MyMap JSON} class represents JSON objects. To create a new
 * JSON object, JSON jsonObject = new JSON(); jsonObject.put("key", value);
 * 
 * @author hieud
 *
 */
...
//			}
   ...
   * 
   * @author hieudm
   * @param str - {@link java.lang.String String} idx - the index of the open
   *            quote
   ...
   * 
   * @author hieudm
   * @param str - {@link java.lang.String String} idx - the index of the first
   *            character in the interested substring in the
