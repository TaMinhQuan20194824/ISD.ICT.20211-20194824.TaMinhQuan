...
import views.screen.rush_order_screen.RushOrderScreenHandler;
...
public class ShippingScreenHandler extends BaseScreenHandler implements Initializable {
  ...
  public ShippingScreenHandler(Stage stage, String screenPath, Order order) throws IOException {
    ...
    this.order = order;
    name.setText("Ta Minh Quan");
    phone.setText("0123456789");
    address.setText("Hai Ba Trung Ha Noi");
  ...
  void submitDeliveryInfo(MouseEvent event) throws IOException, InterruptedException, SQLException {
    ...
    if (isRushOrder.isSelected()) {
      requestToPlaceRushOrder(messages);
    } else {
  ...
  public void requestToPlaceRushOrder(HashMap<String, String> messages) throws IOException {
    RushOrderScreenHandler rushOrderScreenHandler = new RushOrderScreenHandler(this.stage,
        Configs.RUSH_ORDER_SCREEN_PATH, messages, order);
